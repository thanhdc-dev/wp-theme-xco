		...
		********************************/
		...
		var setBulPos = function(container,opt) {
			...
			if (opt.navigationArrows!="none" && opt.navigationArrows!="nexttobullets") {
				...
				/*if (opt.soloArrowLeftValign=="center")	tl.css({'top':'40%','marginTop':(opt.soloArrowLeftVOffset-Math.round(tl.innerHeight()/2))+"px"});
				...
				tl.css({'top':'40%'});
				tl.css({'left':'150px'});
				tl.css({'padding':'15px 5px'});
				tr.css({'top':'40%'});
				tr.css({'left':'280px'});
				tr.css({'padding':'15px 5px'});
			}
